...
```{r setup, echo=FALSE}
library(TradeRa, warn.conflicts = FALSE)
...
* `RCurl`, `xml2`, `tibble`, `tidyr`, and `dplyr` libraries installed in your R environment. These libraries handle API requests, parsing XML, and data manipulation.
...
AppId <- 5205 # Fake AppId, replace with your actual AppId
AppKey <- "180bdaf7-0455-45b5-8750-69ac9225ee6f" # Fake AppKey, replace with your actual AppKey
query <- "Huernia"
pageNumber <- 1
orderBy <- "Relevance"
